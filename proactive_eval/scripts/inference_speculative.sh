...
# Set these paths
MMDUET2_CKPT=Qwen/Qwen2.5-VL-3B-Instruct     # or your fine-tuned checkpoint
ADAPTER_PATH=./kangaroo/adapter_checkpoints/adapter_epoch_best  # path to trained adapter
